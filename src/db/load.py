        ...
        for r in d.real_estate:
            con.execute(
                """INSERT INTO real_estate
                   (decl_id, row_index, kind, owner_type, status,
                    area_m2, other_area_m2, landsize_m2,
                    location_raw, location_decoded,
                    country, region, prefecture, floor, property_condition,
                    build_year, acquisition_year, transfer_year,
                    swimming_pool, energy_production_kw,
                    value_eur, extraction_method, confidence)
                   VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)""",
                (decl_id, r.row_index,
                 r.property_type_decoded or r.property_type_raw,
                 r.owner_type_raw or None,
                 r.status_raw or None,
                 r.covered_area_m2,
                 r.other_area_m2,
                 r.total_area_m2,
                 r.municipality_raw, r.municipality_decoded,
                 r.country_raw or None,
                 r.region_raw or None,
                 r.prefecture_raw or None,
                 r.floor_raw or None,
                 r.property_condition_raw or None,
                 r.build_year,
                 r.acquisition_year,
                 r.transfer_year,
                 r.swimming_pool_m2,
                 r.energy_production_kw,
        ...
        for r in d.real_estate_rights:
            con.execute(
                """INSERT INTO real_estate_acquisition
                   (decl_id, row_index,
                    heir_name, heir_capacity, heir_acquisition_method,
                    rights_type, rights_pct, acquisition_method,
                    price_paid_eur, money_sources,
                    acquisition_contract_number, objective_value_eur,
                    currency, received_price_eur,
                    disposal_contract_number, disposal_objective_value_eur,
                    kaek, notes,
                    extraction_method, confidence)
                   VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)""",
                (decl_id, r.row_index,
                 r.heir_name_raw or None,
                 r.heir_capacity_raw or None,
                 r.heir_acquisition_method_raw or None,
                 r.rights_type_raw,
                 r.rights_pct,
                 r.acquisition_method_decoded or r.acquisition_method_raw,
                 r.price_paid,
                 r.money_sources_raw or None,
                 r.acquisition_contract_number or None,
                 r.objective_value,
                 r.currency or None,
                 r.received_price,
                 r.disposal_contract_number or None,
                 r.disposal_objective_value,
                 r.kaek or None,
                 r.notes_raw or None,
                 r.extraction_method, r.confidence),
            )
